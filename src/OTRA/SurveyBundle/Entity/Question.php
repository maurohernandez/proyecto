...
class Question
{
     ...
     * Set survey
     *
     * @param \OTRA\SurveyBundle\Entity\Survey $survey
     * @return Question
     */
    public function setSurvey(\OTRA\SurveyBundle\Entity\Survey $survey = null)
    {
        $this->survey = $survey;
     ...
     * Get survey
     *
     * @return \OTRA\SurveyBundle\Entity\Survey 
     */
     ...
     * Set questionType
     *
     * @param \OTRA\SurveyBundle\Entity\QuestionType $questionType
     * @return Question
     */
    public function setQuestionType(\OTRA\SurveyBundle\Entity\QuestionType $questionType = null)
    {
     ...
     * Get questionType
     *
     * @return \OTRA\SurveyBundle\Entity\QuestionType 
     */
     ...
     * Set answerType
     *
     * @param \OTRA\SurveyBundle\Entity\AnswerType $answerType
     * @return Question
     */
    public function setAnswerType(\OTRA\SurveyBundle\Entity\AnswerType $answerType = null)
    {
     ...
     * Get answerType
     *
     * @return \OTRA\SurveyBundle\Entity\AnswerType 
     */
     ...
     * Add answers
     *
     * @param \OTRA\SurveyBundle\Entity\Answer $answers
     * @return Question
     */
    public function addAnswer(\OTRA\SurveyBundle\Entity\Answer $answers)
    {
     ...
     * @param \OTRA\SurveyBundle\Entity\Answer $answers
     */
    public function removeAnswer(\OTRA\SurveyBundle\Entity\Answer $answers)
    {
