...
use OTRA\SurveyBundle\Entity\Survey;
use OTRA\SurveyBundle\Form\SurveyType;
...
class SurveyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OTRASurveyBundle:Survey')->findAll();

        return $this->render('OTRASurveyBundle:Survey:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('OTRASurveyBundle:Survey:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OTRASurveyBundle:Survey')->find($id);
        ...
        return $this->render('OTRASurveyBundle:Survey:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('OTRASurveyBundle:Survey:edit.html.twig', array(
            'entity'      => $entity,
